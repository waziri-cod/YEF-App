...
// the env file defines VITE_API_URL (old name was VITE_API_BASE_URL)
// keep backwards compatibility by checking both.
const API_BASE_URL =
...
export const authService = {
  async register(
    ...
    try {
      ...
      // handle network failures separately to give a clearer message
      let message: string;
      if (error instanceof TypeError && error.message === "Failed to fetch") {
        message =
          "Unable to reach authentication server. Please check your network or ensure the backend is running.";
      } else {
